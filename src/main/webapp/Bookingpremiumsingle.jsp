...
<h2>Book Your Premium Single Room</h2>
...
<form id="bookingForm" method="post" action="book-room">
    ...
    <input type="text" id="roomType" name="roomType" value="Premium Single" class="readonly-field" readonly>

    <label for="price">Price (Per Night):</label>
    <input type="text" id="price" name="price" value="₹5000" class="readonly-field" readonly>

    <label for="totalAmount">Total Amount:</label>
    <input type="text" id="totalAmount" value="₹5000" class="readonly-field" readonly>

    <!-- ✅ Hidden input to submit raw numeric amount -->
    <input type="hidden" id="hiddenAmount" name="totalAmount" value="5000">
...
<script>
    ...
    function calculateTotalAmount() {
        ...
        if (checkin && checkout && checkout > checkin) {
            ...
            totalAmountInput.value = "₹5000";
            hiddenAmount.value = "5000";
        }
    }
