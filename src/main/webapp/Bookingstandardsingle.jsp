...
<h2>Book Your Standard Single Room</h2>
...
<form id="bookingForm" method="post" action="book-room">
    ...
    <input type="text" id="roomType" name="roomType" value="Standard Single" class="readonly-field" readonly>

    <label for="price">Price (Per Night):</label>
    <input type="text" id="price" name="price" value="₹3000" class="readonly-field" readonly>

    <label for="totalAmount">Total Amount:</label>
    <input type="text" id="totalAmount" value="₹3000" class="readonly-field" readonly>

    <!-- Hidden input to send raw numeric amount -->
    <input type="hidden" id="hiddenAmount" name="totalAmount" value="3000">
...
<script>
    ...
    function calculateTotalAmount() {
        ...
        if (checkin && checkout && checkout > checkin) {
            ...
            totalAmountInput.value = "₹3000";
            hiddenAmount.value = "3000";
        }
    }
